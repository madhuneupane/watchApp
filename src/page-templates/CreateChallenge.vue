<template>
    ...
    <div v-if="this.sSectionOn">
        ...
        <section id="recommendPageSec">
            <div class="movieList">
                <div id="movieSelected" @click.prevent="chose" class="movieItem" :key="movie"
    ...
    <div v-if="this.tSectionOn">
        ...
        <p id="small">
            This will be cover of the challenge. You can select from the default image or you can upload the one you
            want!
        </p>
...
export default {
    ...
    created() {
        this.chooseMovie = axios.get("https://api.themoviedb.org/3/movie/popular?api_key=8ec942643846f64d66eed102868455f3&language=en-US&page=1&region=US")
            .then((info) => {
    ...
    methods: {
        ...
        chose() {
            document.getElementById("movieSelected").innerHTML = `<img v-bind:src= "a" class="movieItem" style="width: 100%" />`;
        },
        backSelection() {
            this.fSectionOn = false;
            this.sSectionOn = true;
